...
While I work on full documentation (you can see the work in progress here: [https://etherdocs.myzopotamia.dev](https://etherdocs.myzopotamia.dev)), here are some of the features I personally find cool about my homelab:
...
Full documentation is being worked on. In the meantime, check out the diagram :)

![Ether overview diagram](/docs/assets/diagrams/ether_overview.png)
...
Everything you see here, with the exception of the [documentation page](https://etherdocs.myzopotamia.dev), has been **written by a human (me) entirely**, although with research done using OpenAI's Chat GPT.

Documentation at [https://etherdocs.myzopotamia.dev](https://etherdocs.myzopotamia.dev) is my testing grounds for running an agent with a local AI model and was thus initially generated by said agent and then fixed up manually by me. This is a work in progress.
...
I am a DevOps Engineer by trade and I just pretty much like doing what I do. This homelab setup is here so I can practice my skills. I do realize it is probably over-engineered and could be done much simpler, but it's a deliberate choice with learning in mind :)